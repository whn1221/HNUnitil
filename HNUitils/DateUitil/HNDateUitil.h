...
static NSString *kNSDateHelperFormatSQLDateWithTime1    = @"yyyyMMdd";
static NSString *kNSDateHelperFormatSQLStartAndEndDate  = @"yyyy-MM";

@interface HNDateUitil : NSObject
